...
export const QUIZ_FOODS: QuizFood[] = [
  ...
  { name: "Chapati / Roti", emoji: "🫓", group: "grains" },
  { name: "Bread", emoji: "🍞", group: "grains" },
  { name: "Potato", emoji: "🥔", group: "grains" },
  { name: "Toor Dal", emoji: "🍲", group: "pulses" },
  { name: "Rajma (Kidney Beans)", emoji: "🫘", group: "pulses" },
  { name: "Chana (Chickpeas)", emoji: "🫛", group: "pulses" },
  { name: "Moong Dal", emoji: "🥣", group: "pulses" },
  { name: "Groundnut / Peanut", emoji: "🥜", group: "nuts" },
  { name: "Almond", emoji: "🌰", group: "nuts" },
  { name: "Walnut", emoji: "🥥", group: "nuts" },
  { name: "Milk", emoji: "🥛", group: "dairy" },
  { name: "Curd / Dahi", emoji: "🍶", group: "dairy" },
  { name: "Paneer", emoji: "🧀", group: "dairy" },
  { name: "Butter", emoji: "🧈", group: "dairy" },
  ...
  { name: "Palak (Spinach)", emoji: "🥬", group: "dglv" },
  ...
  { name: "Brinjal (Eggplant)", emoji: "🍆", group: "otherVeg" },
  { name: "Cauliflower", emoji: "🥦", group: "otherVeg" },
  { name: "Onion", emoji: "🧅", group: "otherVeg" },
  { name: "Cucumber", emoji: "🥒", group: "otherVeg" },
  ...
  { name: "Pomegranate", emoji: "🍅", group: "otherFruit" },
];
